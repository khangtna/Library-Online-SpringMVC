			...
			<main id="main" class="site-main">
				<div class="books-full-width">
					<div class="container">
						...
						<c:if test="${ booksPaginate.size() > 0 }">
						<div class="booksmedia-fullwidth">
											
							<ul>
								<c:forEach var="item" items="${booksPaginate }" varStatus="loop" >
								...
								<c:if test="${(loop.index + 1)%3==0 || (loop.index +1 ) == booksPaginate.size() }">
								
							</ul>
							</div>
								<c:if test="${(loop.index +1 )< booksPaginate.size() }" >
						...
						<nav class="navigation pagination text-center">
							...
							<c:forEach var="item" begin="1" end="${paginatesInfo.totalPage }" varStatus="loop" >
								...
								<a
									class="next page-numbers" href="#.">Next <i
